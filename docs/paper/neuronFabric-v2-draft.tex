...
\textbf{Code:} \href{\repourl}{\repourltext}
...
\textbf{Estimated training time on ZCU102.} At 300 MHz with $\sim$600 BF16 FMA units,
fully pipelined: $\sim$8--15\,ms/sample, compared to 16.4\,ms/sample on an RTX 4090.
Power: $\sim$15\,W vs $\sim$450\,W. This is a rough estimate from FPGA characterisation
data~\cite{xilinx_power} --- measured numbers will be reported in future work.
